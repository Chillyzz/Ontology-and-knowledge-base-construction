...
instruction = "You are a professional translator. When you are given an English text about a math problem, you need to break it down into multiple simple sentences and make sure that each simple sentence is a complete statement, that is, each entity variable has its own name. And add $ signs on both sides of the variables and formulas."
...
def main():
    client = OpenAI(api_key="sk-8532a64c13f74a4392e94db560073553", base_url="https://api.deepseek.com")

    test_f = r'/home/zjy17/Conic10k/conic10k/new_openai.json'
    output = r'/home/zjy17/Conic10k/conic10k/translation_test.json'

    shots_file = open('/home/zjy17/Conic10k/conic10k/translation_fewshots.json','r',encoding='utf-8')
    ...
    for j, data in enumerate(test_datas):
        # if 0 <= j < 100:
            ...
            d['new_text'] = ans
            #d['fact_expressions'] = data['facts']
            #d['query_expressions'] = data['query']
