...
def main():
    ...
    train_f = r'/home/zjy17/Conic10k/conic10k/semantic_fewshots.json'  # 候选池数据
    test_f = r'/home/zjy17/Conic10k/conic10k/translation_new.json' # 测试数据
    output = r'/home/zjy17/Conic10k/conic10k/semantic_test.json' # 输出文件

    test = open(test_f,'r',encoding='utf-8')
    train = open(train_f,'r',encoding='utf-8')
    f1 = open(output,'a',encoding='utf-8')

    text_to_ops_file = open('/home/zjy17/Conic10k/operators_data/text_to_ops.json','r',encoding='utf-8')
    text_to_ops = json.load(text_to_ops_file)

    operators_file = open('/home/zjy17/Conic10k/operators_data/operators.json','r',encoding='utf-8')
