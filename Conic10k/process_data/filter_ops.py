...
def main():
    ...
    train_f = r'/home/zjy17/conic10k/conic10k/top_200_rich_datas_cluster_with_text.json'
    test_f = r'/home/zjy17/conic10k/new_data/test_300_breakdown.json'
    output = r'/home/zjy17/conic10k/Few-shot/text_300_filter_ops.json'

    operators_file = open('/home/zjy17/conic10k/Few-shot/operators.json','r',encoding='utf-8')
