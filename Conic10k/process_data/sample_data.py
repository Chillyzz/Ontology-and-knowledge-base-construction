...
def extract_data(indices):
    with open('/data/zjy17/conic10k/eval_models/outputs/extrac_answer/baseline/deepseek-math-7b-rl-by-gpt4o.json', 'r', encoding='utf-8') as f:
        datas = json.load(f)
    result = []
    for index in indices:
        result.append(datas[index])
    with open('/data/zjy17/conic10k/eval_models/outputs/extrac_answer/baseline/deepseek-math-7b-rl-by-gpt4o_300.json', 'w', encoding='utf-8') as f:
